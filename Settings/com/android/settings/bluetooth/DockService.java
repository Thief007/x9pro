...
public final class DockService extends Service implements ServiceListener {
    ...
    private final OnCheckedChangeListener mCheckedChangeListener = new C03102();
    private boolean[] mCheckedItems;
    private final OnClickListener mClickListener = new C03124();
    private BluetoothDevice mDevice;
    private CachedBluetoothDeviceManager mDeviceManager;
    private AlertDialog mDialog;
    private final OnDismissListener mDismissListener = new C03113();
    private LocalBluetoothAdapter mLocalAdapter;
    private final OnMultiChoiceClickListener mMultiClickListener = new C03091();
    ...
    class C03091 implements OnMultiChoiceClickListener {
        C03091() {
        }
    ...
    class C03102 implements OnCheckedChangeListener {
        C03102() {
        }
    ...
    class C03113 implements OnDismissListener {
        C03113() {
        }
    ...
    class C03124 implements OnClickListener {
        C03124() {
        }
