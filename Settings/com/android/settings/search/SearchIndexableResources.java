...
public final class SearchIndexableResources {
    ...
    static {
        ...
        if (FeatureOption.MTK_AUDIO_PROFILES) {
            sResMap.put(AudioProfileSettings.class.getName(), new SearchIndexableResource(Ranking.getRankForClassName(AudioProfileSettings.class.getName()), NO_DATA_RES_ID, AudioProfileSettings.class.getName(), R.drawable.ic_settings_notifications));
            sResMap.put(SoundEnhancement.class.getName(), new SearchIndexableResource(Ranking.getRankForClassName(SoundEnhancement.class.getName()), NO_DATA_RES_ID, SoundEnhancement.class.getName(), R.drawable.ic_settings_notifications));
        } else {
        ...
        sResMap.put(AdvancedAppSettings.class.getName(), new SearchIndexableResource(Ranking.getRankForClassName(AdvancedAppSettings.class.getName()), R.xml.advanced_apps, AdvancedAppSettings.class.getName(), R.drawable.ic_settings_applications));
        sResMap.put(ManageDefaultApps.class.getName(), new SearchIndexableResource(Ranking.getRankForClassName(ManageDefaultApps.class.getName()), NO_DATA_RES_ID, ManageDefaultApps.class.getName(), R.drawable.ic_settings_applications));
        ...
        sResMap.put(WifiCallingSettings.class.getName(), new SearchIndexableResource(Ranking.getRankForClassName(WifiCallingSettings.class.getName()), R.xml.wifi_calling_settings, WifiCallingSettings.class.getName(), R.drawable.ic_settings_wireless));
