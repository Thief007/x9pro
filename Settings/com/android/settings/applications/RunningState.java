...
public class RunningState {
    ...
    final Comparator<MergedItem> mBackgroundComparator = new C02841();
    ...
    final Handler mHandler = new C02852();
    boolean mHaveData;
    ...
    class C02841 implements Comparator<MergedItem> {
        C02841() {
        }
        ...
        public int compare(MergedItem lhs, MergedItem rhs) {
            ...
            if (lhs.mUserId != rhs.mUserId) {
                ...
                if (lhs.mLabel != null) {
                    i2 = lhs.mLabel.compareTo(rhs.mLabel);
                }
                return i2;
    ...
    static class MergedItem extends BaseItem {
        ...
        public Drawable loadIcon(Context context, RunningState state) {
            ...
            if (this.mUser.mIcon == null) {
                return context.getDrawable(17302457);
            }
    ...
    private boolean update(Context context, ActivityManager am) {
        ...
        while (true) {
            ...
            changed |= proc.updateSize(context, (long) (((float) pss[i]) + (((float) pswap[i]) / zramCompressRatio)), this.mSequence);
            if (proc.mCurSeq == this.mSequence) {
