...
public class ProcStatsPackageEntry implements Parcelable {
    public static final Creator<ProcStatsPackageEntry> CREATOR = new C02721();
    ...
    static class C02721 implements Creator<ProcStatsPackageEntry> {
        C02721() {
        }
    ...
    public static CharSequence getFrequency(float amount, Context context) {
        if (amount > 0.95f) {
            return context.getString(R.string.always_running, new Object[]{Utils.formatPercentage((int) (100.0f * amount))});
        } else if (amount > 0.25f) {
            return context.getString(R.string.sometimes_running, new Object[]{Utils.formatPercentage((int) (100.0f * amount))});
        } else {
            return context.getString(R.string.rarely_running, new Object[]{Utils.formatPercentage((int) (100.0f * amount))});
        }
    }
}
