...
public class AppOpsState {
    ...
    public static final Comparator<AppOpEntry> APP_OP_COMPARATOR = new C02391();
    ...
    static class C02391 implements Comparator<AppOpEntry> {
    ...
    public static class OpsTemplate implements Parcelable {
        public static final Creator<OpsTemplate> CREATOR = new C02401();
        public final int[] ops;
        public final boolean[] showPerms;

        static class C02401 implements Creator<OpsTemplate> {
            C02401() {
            }
