...
public abstract class AppInfoBase extends SettingsPreferenceFragment implements Callbacks {
    ...
    public static void startAppInfoFragment(Class<?> fragment, int titleRes, String pkg, int uid, Fragment source, int request) {
        ...
        args.putInt("uid", uid);
        source.getActivity().startActivityForResultAsUser(Utils.onBuildStartFragmentIntent(source.getActivity(), fragment.getName(), args, null, titleRes, null, false), request, new UserHandle(UserHandle.getUserId(uid)));
    }
}
