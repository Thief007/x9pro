...
public abstract class AppStateAppOpsBridge extends AppStateBaseBridge {
    ...
    public PermissionState getPermissionInfo(String pkg, int uid) {
        ...
        try {
            permissionState.packageInfo = this.mIPackageManager.getPackageInfo(pkg, 4096, permissionState.userHandle.getIdentifier());
    ...
    protected void loadAllExtraInfo() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (userMap != null) {
                obj = (PermissionState) userMap.get(app.info.packageName);
            } else {
                obj = null;
            }
            app.extraInfo = obj;
