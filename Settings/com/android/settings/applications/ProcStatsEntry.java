...
public final class ProcStatsEntry implements Parcelable {
    public static final Creator<ProcStatsEntry> CREATOR = new C02701();
    ...
    static class C02701 implements Creator<ProcStatsEntry> {
        C02701() {
        }
    ...
    public static final class Service implements Parcelable {
        public static final Creator<Service> CREATOR = new C02711();
        final long mDuration;
        final String mName;
        final String mPackage;
        final String mProcess;

        static class C02711 implements Creator<Service> {
            C02711() {
            }
    ...
    public ProcStatsEntry(ProcessState proc, String packageName, ProcessDataCollection tmpBgTotals, ProcessDataCollection tmpRunTotals, boolean useUss) {
        ...
        if (DEBUG) {
            Log.d("ProcStatsEntry", "New proc entry " + proc.mName + ": dur=" + this.mBgDuration + " avgpss=" + this.mAvgBgMem + " weight=" + this.mBgWeight);
        }
    }
    ...
    public ProcStatsEntry(String pkgName, int uid, String procName, long duration, long mem) {
        ...
        this.mMaxBgMem = mem;
        this.mAvgBgMem = mem;
        double d = ((double) duration) * ((double) mem);
        this.mRunWeight = d;
        this.mBgWeight = d;
        if (DEBUG) {
