...
public class ServiceListing {
    ...
    private final BroadcastReceiver mPackageReceiver = new C04532();
    ...
    class C04532 extends BroadcastReceiver {
        C04532() {
        }
    ...
    public static ServiceInfo findService(Context context, Config config, ComponentName cn) {
        for (ServiceInfo service : new ServiceListing(context, config).reload()) {
