...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        this.mDreamsEnabledByDefault = context.getResources().getBoolean(17956965);
        this.mDreamsActivatedOnSleepByDefault = context.getResources().getBoolean(17956967);
        this.mDreamsActivatedOnDockByDefault = context.getResources().getBoolean(17956966);
    }
