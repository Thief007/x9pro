...
public class StorageMeasurement {
    ...
    private class MainHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (measurementReceiver != null) {
                measurementReceiver.onDetailsChanged(details);
            }
        }
    }
    ...
    private class MeasurementHandler extends Handler {
        ...
        private final ServiceConnection mDefContainerConn = new C06631();
            ...
            switch (msg.what) {
                case 1:
                    if (this.mCached == null) {
                        ...
                        synchronized (obj) {
                            if (!this.mBound) {
                                StorageMeasurement.this.mContext.bindServiceAsUser(new Intent().setComponent(StorageMeasurement.DEFAULT_CONTAINER_COMPONENT), this.mDefContainerConn, 1, UserHandle.OWNER);
                                break;
                            }
                            removeMessages(3);
        ...
        if (this.mVolume.getType() == 1) {
            ...
            for (UserInfo user2 : users) {
                for (ApplicationInfo app2 : volumeApps) {
                    packageManager.getPackageSizeInfo(app2.packageName, user2.id, observer);
                }
            }
            return;
        }
