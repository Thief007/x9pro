...
public class ChartSweepView extends View {
    ...
    public ChartSweepView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mClickListener = new C07501();
    ...
    private void invalidateLabelTemplate() {
        if (this.mLabelTemplateRes != 0) {
            ...
            paint.setShadowLayer(paint.density * 4.0f, 0.0f, 0.0f, -16777216);
    ...
    public void setValue(long value) {
        if (this.mMaxValue == -1 || value <= this.mMaxValue) {
            this.mValue = value;
        } else {
            Log.i("@M_ChartSweepView", "big value " + value);
