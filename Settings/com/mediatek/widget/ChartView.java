...
public class ChartView extends FrameLayout {
    ...
    protected void layoutSweep(ChartSweepView sweep, Rect parentRect, Rect childRect) {
        ...
        if (sweep.getFollowAxis() == 1) {
            ...
            Gravity.apply(51, parentRect.width(), sweep.getMeasuredHeight(), parentRect, childRect);
            return;
        }
        ...
        Gravity.apply(51, sweep.getMeasuredWidth(), parentRect.height(), parentRect, childRect);
    }
}
