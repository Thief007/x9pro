...
public final class PlaybackStateCompat implements Parcelable {
    public static final Creator<PlaybackStateCompat> CREATOR = new C00151();
    ...
    static class C00151 implements Creator<PlaybackStateCompat> {
        C00151() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00161();
        private final String mAction;
        private final Bundle mExtras;
        private final int mIcon;
        private final CharSequence mName;

        static class C00161 implements Creator<CustomAction> {
            C00161() {
            }
