...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childHeightSpec = MeasureSpec.makeMeasureSpec(Math.max(0, childHeight), Integer.MIN_VALUE);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
    ...
    private void initLongStringSetting() {
        if (this.mPrevText != null && this.mCurrText != null && this.mNextText != null) {
            ...
            this.mCurrText.setSingleLine();
            this.mNextText.setSingleLine();
            this.mPrevText.setEllipsize(TruncateAt.MARQUEE);
            this.mCurrText.setEllipsize(TruncateAt.MARQUEE);
            this.mNextText.setEllipsize(TruncateAt.MARQUEE);
