...
public class ViewPager extends ViewGroup {
    private static final Comparator<ItemInfo> COMPARATOR = new C00241();
    private static final boolean IS_ENG_BUILD = "eng".equals(Build.TYPE);
    private static final int[] LAYOUT_ATTRS = new int[]{16842931};
    private static final Interpolator sInterpolator = new C00252();
    ...
    private final Runnable mEndScrollRunnable = new C00263();
    ...
    static class C00241 implements Comparator<ItemInfo> {
        C00241() {
        }
    ...
    static class C00252 implements Interpolator {
        C00252() {
        }
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (dx != 0.0f && !isGutterDrag(this.mLastMotionX, dx) && canScroll(this, false, (int) dx, (int) x2, (int) y)) {
                        ...
                        return false;
                    } else if (xDiff >= ((float) this.mTouchSlopAdjust) || yDiff >= ((float) this.mTouchSlopAdjust) || !pointInRect(ev, this.mSpecRect)) {
        ...
        switch (ev.getAction() & 255) {
            ...
            case 2:
                if (!this.mIsBeingDragged) {
                    ...
                    if (pointerIndex == -1) {
                        if (IS_ENG_BUILD) {
                            Log.e("ViewPager", "Invalid pointerId=" + this.mActivePointerId + " in onTouchEvent ACTION_MOVE");
                            break;
                        }
                    }
                    float x2 = MotionEventCompat.getX(ev, pointerIndex);
