    ...
    public void onCreate(Bundle icicle) {
        ...
        try {
            ...
            try {
                ...
                if (this.mPackageName.equals("com.qihoo.gamelive")) {
                    this.actionText = getString(R.string.media_projection_dialog_text_custom, new Object[]{appName});
                } else {
                    this.actionText = getString(R.string.media_projection_dialog_text, new Object[]{appName});
                }
                SpannableString message = new SpannableString(this.actionText);
                int appNameIndex = this.actionText.indexOf(appName);
                if (appNameIndex >= 0) {
