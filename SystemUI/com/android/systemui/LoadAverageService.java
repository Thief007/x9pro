    ...
    private class LoadView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (totalTime != 0) {
                ...
                canvas.drawText(stats.mLoadText, (float) (((RIGHT - paddingRight) - stats.mLoadWidth) - 1), (float) (y - 1), this.mShadowPaint);
                canvas.drawText(stats.mLoadText, (float) (((RIGHT - paddingRight) - stats.mLoadWidth) - 1), (float) (y + 1), this.mShadowPaint);
                canvas.drawText(stats.mLoadText, (float) (((RIGHT - paddingRight) - stats.mLoadWidth) + 1), (float) (y - 1), this.mShadow2Paint);
                canvas.drawText(stats.mLoadText, (float) (((RIGHT - paddingRight) - stats.mLoadWidth) + 1), (float) (y + 1), this.mShadow2Paint);
                canvas.drawText(stats.mLoadText, (float) ((RIGHT - paddingRight) - stats.mLoadWidth), (float) y, this.mLoadPaint);
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    canvas.drawText(st.name, (float) (((RIGHT - paddingRight) - st.nameWidth) - 1), (float) (y - 1), this.mShadowPaint);
                    canvas.drawText(st.name, (float) (((RIGHT - paddingRight) - st.nameWidth) - 1), (float) (y + 1), this.mShadowPaint);
                    canvas.drawText(st.name, (float) (((RIGHT - paddingRight) - st.nameWidth) + 1), (float) (y - 1), this.mShadow2Paint);
                    canvas.drawText(st.name, (float) (((RIGHT - paddingRight) - st.nameWidth) + 1), (float) (y + 1), this.mShadow2Paint);
                    ...
                    canvas2.drawText(st.name, (float) ((RIGHT - paddingRight) - st.nameWidth), (float) y, p);
                }
            }
        }
