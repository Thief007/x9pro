...
public class DndTile extends QSTile<BooleanState> {
    ...
    private final AnimationIcon mDisable = new AnimationIcon(R.drawable.ic_dnd_disable_animation);
    private final AnimationIcon mDisableTotalSilence = new AnimationIcon(R.drawable.ic_dnd_total_silence_disable_animation);
    ...
    public void handleClick() {
        if (this.mController.isVolumeRestricted()) {
            ...
            SysUIToast.makeText(this.mContext, this.mContext.getString(17040622), 1).show();
            return;
        }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        switch (zen) {
            ...
            default:
                ...
                state.contentDescription = this.mContext.getString(R.string.accessibility_quick_settings_dnd_off);
                break;
        }
