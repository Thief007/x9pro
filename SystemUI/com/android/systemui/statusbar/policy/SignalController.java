...
public abstract class SignalController<T extends State, I extends IconGroup> {
    ...
    static class State {
        ...
        public void copyFrom(State state) {
            ...
            this.mShowDataActivityIcon = state.mShowDataActivityIcon;
        }
        ...
        public boolean equals(Object o) {
            ...
            State other = (State) o;
            if (other.connected == this.connected && other.enabled == this.enabled && other.level == this.level && other.inetCondition == this.inetCondition && other.iconGroup == this.iconGroup && other.activityIn == this.activityIn && other.activityOut == this.activityOut && other.mShowDataActivityIcon == this.mShowDataActivityIcon && other.rssi == this.rssi) {
                z = true;
            }
            return z;
        }
    ...
    public int getContentDescription() {
        ...
        Log.i("fenghaitao", "=======getContentDescription==mCurrentState.level=" + this.mCurrentState.level + "===length=" + getIcons().mContentDesc.length);
