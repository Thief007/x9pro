...
public class StatusBarHeaderView extends RelativeLayout implements OnClickListener, BatteryStateChangeCallback, NextAlarmChangeCallback, EmergencyListener {
    ...
    private final Callback mQsPanelCallback = new Callback() {
        ...
        public void onShowingDetail(final DetailAdapter detail) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        this.mEmergencyCallsOnly.setText(17039995);
