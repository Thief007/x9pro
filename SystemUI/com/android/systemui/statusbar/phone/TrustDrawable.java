...
public class TrustDrawable extends Drawable {
    ...
    private Animator makeVisibleAnimator() {
        return makeAnimators(this.mInnerRadiusVisibleMax, this.mInnerRadiusVisibleMin, 76, 38, 1000, this.mAccelerateDecelerateInterpolator, true, false);
    }

    private Animator makeEnterAnimator(float radius, int alpha) {
        return makeAnimators(radius, this.mInnerRadiusVisibleMax, alpha, 76, 500, this.mLinearOutSlowInInterpolator, false, true);
    }

    private Animator makeExitAnimator(float radius, int alpha) {
        return makeAnimators(radius, this.mInnerRadiusExit, alpha, 0, 500, this.mFastOutSlowInInterpolator, false, true);
    }
