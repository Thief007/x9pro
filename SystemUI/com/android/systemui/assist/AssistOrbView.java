...
public class AssistOrbView extends FrameLayout {
    ...
    public void startExitAnimation(long delay) {
        animateCircleSize(0.0f, 200, delay, this.mDisappearInterpolator);
        animateOffset(0.0f, 200, delay, this.mDisappearInterpolator);
    }
    ...
    public void startEnterAnimation() {
        ...
        post(new Runnable() {
            public void run() {
                ...
                AssistOrbView.this.animateOffset((float) AssistOrbView.this.mStaticOffset, 400, 0, AssistOrbView.this.mAppearInterpolator);
            }
        });
    }
