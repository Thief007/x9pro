...
public class VolumeDialogController {
    ...
    public VolumeDialogController(Context context, ComponentName component) {
        ...
        this.soundPoolMap.put(Integer.valueOf(1), Integer.valueOf(this.soundPool.load(this.mContext, R.raw.volumekey, 1)));
    }
    ...
    private boolean checkRoutedToBluetoothW(int stream) {
        ...
        return updateStreamRoutedToBluetoothW(stream, (this.mAudio.getDevicesForStream(3) & 896) != 0);
    }
