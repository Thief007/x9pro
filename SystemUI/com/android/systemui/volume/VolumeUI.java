...
public class VolumeUI extends SystemUI {
    ...
    private final class RestorationNotification {
        ...
        public void show() {
            ...
            VolumeUI.this.mNotificationManager.notify(R.id.notification_volumeui, new Builder(VolumeUI.this.mContext).setSmallIcon(R.drawable.ic_volume_media).setWhen(0).setShowWhen(false).setOngoing(true).setContentTitle(VolumeUI.this.mContext.getString(R.string.volumeui_notification_title, new Object[]{VolumeUI.this.getAppLabel(component)})).setContentText(VolumeUI.this.mContext.getString(R.string.volumeui_notification_text)).setContentIntent(PendingIntent.getBroadcast(VolumeUI.this.mContext, 0, intent, 134217728)).setPriority(-2).setVisibility(1).setColor(VolumeUI.this.mContext.getColor(17170521)).build());
        }
    }
