...
public class KeyguardSecurityViewFlipper extends ViewFlipper implements KeyguardSecurityView {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (widthMode != Integer.MIN_VALUE) {
            Log.w("KeyguardSecurityViewFlipper", "onMeasure: widthSpec " + MeasureSpec.toString(widthSpec) + " should be AT_MOST");
        }
        if (heightMode != Integer.MIN_VALUE) {
            Log.w("KeyguardSecurityViewFlipper", "onMeasure: heightSpec " + MeasureSpec.toString(heightSpec) + " should be AT_MOST");
        }
